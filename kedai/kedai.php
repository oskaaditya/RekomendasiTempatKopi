      ...
      <div id="content">
         ...
         <div id="section2" class="section about_section layout_padding dash_bg">
            <div class="container">
               ...
               <div class="row">
                    <div class="card">
                        <img src="images/hompimpa.jpeg" alt="Hompimpa" style="width:100%">
                        <h1>KOPI HOMPIMPA</h1>
                        <p class="desc">Jalan Ikan Tombro No 25 , Kota Malang</p>
                        <a href="detailskedai.php"><button>More</button></a>
                    </div>
                    <div class="card">
                        <img src="images/hompimpa.jpeg" alt="Hompimpa" style="width:100%">
                        <h1>KOPI HOMPIMPA</h1>
