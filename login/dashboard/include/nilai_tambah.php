...
<div class="box-header">
	<h3 class="box-title">Tambah Kriteria Kedai Kopi</h3>
</div>
<form method="POST" action="">
	<div class="form-group">
		<label class="control-label col-lg-2">Pilih Kedai Kopi</label>
		<div class="col-lg-4">
...
if($cek_l>0){
	$del=mysqli_query($conn, "delete from nilai where id_alternatif='$id_alt'");
}
for($n=1;$n<=$jml_krit;$n++){
	$id_k=$_POST['id_krite'.$o];
	 $nilai=$_POST['nilai'.$o];
	$m=mysqli_query($conn, "insert into nilai (id_alternatif,id_kriteria,nilai) values('$_POST[id_alt]','$id_k','$nilai')");
	$o++;
}
}
?>